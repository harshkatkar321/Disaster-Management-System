...
//		disaster.setUser(user);
	    ...
	    disaster.setMapLocation(point);
		 ...
		 Disaster save = disasterRepository.save(disaster);
		 
		 List<String> adminEmails = adminRepository.findUsernameByCityContainingIgnoreCase(dto.getLocation());
		 
		 Thread threadA = new Thread(() -> {
			 
			 for (String email : adminEmails) {
				 
					emailService.sendEmail(email, dto.getType()+" at "+dto.getLocation(), dto.getDescription());
				}
