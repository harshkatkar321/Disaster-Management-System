...
public class AlertController {
	...
	@PostMapping("/alerts/withoutdisaster")
	public ResponseEntity<?> createAlertWithoutDisaster(@RequestPart @Valid AlertWithoutUserDto dto, BindingResult br, 
		...
		try {
			Alert alert = alertService.createAlertWithoutuser(dto, imageFile);
			return new ResponseEntity<>(alert, HttpStatus.CREATED);
		} catch (Exception e) {
			// TODO: handle exception
			return new ResponseEntity<>(e.getMessage(), HttpStatus.BAD_GATEWAY);
