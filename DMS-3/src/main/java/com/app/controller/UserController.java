...
public class UserController {
	...
	@PostMapping("/users/sms/{city}")
	public ResponseEntity<?> sendSms(@PathVariable String city, @RequestBody SmsDto smsDto, BindingResult br){
		...
		try {
			myUserService.sendSmsByCity(city, smsDto);
	...
	public ResponseEntity<?> changePassword(@RequestBody @Valid ChangePasswordDto dto,  BindingResult br){
		...
		try {
			boolean result = myUserService.changePassword(dto);
			if(result) {
				String message = "Password Changed Successfully!";
				return new ResponseEntity<>(message, HttpStatus.OK);
			}
			else {
				String message = "Old password not matching !";
