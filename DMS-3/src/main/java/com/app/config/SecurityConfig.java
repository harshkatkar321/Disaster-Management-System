	...
	public SecurityFilterChain securityFilterChain(HttpSecurity http,  CorsConfigurationSource corsConfig) throws Exception {
	    return http
	      ...
	      .authorizeHttpRequests(auth -> auth
	          .requestMatchers("/api/v1/login", "/api/v1/register",  "/api/v1/resource", "/api/v1/verifyaccount",
	        		  "api/v1/regenerateotp",
	        		  "api/v1/forgotpasswordotp", "api/v1/setNewPassword").permitAll()
	          ...
	          .requestMatchers("/api/resources/**").hasAnyRole("ADMIN", "SUPER_ADMIN")
